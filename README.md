...
## ⚙️ Instalação
**⚠️ Para rodar está aplicação deve-se se obter node.js e MySql instalados em sua máquin a, passível de obter um software para gerenciar o banco de dados(Workbench e etc), apenas para cria-lo**
